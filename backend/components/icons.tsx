...
export function PlayArrowIcon({ className }: { className?: string }) {
  return (
...
export function SkipNextIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M6 18l8.5-6L6 6v12zm2-12v12l6.5-6L8 6zm8.5 6V6l2 2v12l-2 2V6z" />
    </svg>
  );
}
...
export function VolumeUpIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
