...
封面匹配链扩展为 iTunes→kw→mg→kg→tx→wy；单测与 spec 同步。
...
## Session 48: 在线补缺artist/album

**Date**: 2026-07-13
**Task**: 在线补缺artist/album
**Branch**: `main`

### Summary

新增 metadata 模块；播放时仅补缺写回 artist/album；封面链对齐 any-listen。
...
弱 title（=文件名）可写相关在线标题；强 title 不覆盖。
...
## Session 50: 歌词编排层 matchOnlineLyrics

**Date**: 2026-07-13
**Task**: 歌词编排层 matchOnlineLyrics
**Branch**: `main`

### Summary

amll 优先的可插拔回退编排；controller 接入；平台/LRCLIB 待挂。
...
kw/tx/wy/kg/mg 歌词 fallback；yrc/qrc 展示；AMLL 解析。
