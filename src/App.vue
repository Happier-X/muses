...
/** 一级 tab 页（歌曲/专辑/艺术家/歌单/音源/设置）返回 = 退出应用；二级页（详情等）返回上一页 */
const topLevelPaths = ['/tabs/songs', '/tabs/albums', '/tabs/artists', '/tabs/playlists', '/tabs/sources', '/tabs/settings', '/tabs/scrape']
