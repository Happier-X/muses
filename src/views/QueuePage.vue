  ...
  >
    <div class="flex flex-col h-full overflow-hidden overscroll-none">
      ...
      <div class="flex-1 min-h-0 overflow-hidden">
        ...
        <div v-else ref="listParentRef" class="h-full overflow-auto overscroll-contain box-border pb-[calc(var(--muses-mini-player-height)+var(--muses-space-xl)+env(safe-area-inset-bottom,0px))]" role="list" aria-label="播放队列歌曲" @touchstart.stop @touchmove.stop @touchend.stop @touchcancel.stop>
