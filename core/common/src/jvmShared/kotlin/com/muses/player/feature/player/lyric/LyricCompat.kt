 ...
 * 而内部实现使用新的  类型。
 *
 * 09-05-desktop-player-lyrics Y1/Y2：自 feature:player 上收 :core:common jvmShared
 * （同包名透传，安卓零改动）；桌面 DesktopPlayerHook 复用同一解析链保证解析语义一致。
 * 仅 [AmllMapper]（依赖 accompanist lyrics-core，仅安卓消费）留在 feature:player。
 */
