...
/**
 * 多层 box-shadow 绘制方案（design.md §2 定案）：
 *
 * Compose 无原生多层 box-shadow，采用 **drawBehind + nativeCanvas(Paint + BlurMaskFilter)**：
 ...
 */
fun Modifier.saltShadow(shape: Shape, layers: List<SaltShadowLayer>): Modifier =
    drawBehind {
