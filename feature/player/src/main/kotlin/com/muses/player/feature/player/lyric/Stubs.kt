...
object SettingsRuntime {
    ...
    const val lyricCascadeBounce: Float = 0.14f
    const val lyricCascadeBounceEnabled: Boolean = true
    const val lyricCascadeBounceGradient: Float = 0.6f
    const val lyricCascadeCatchUpRatio: Float = 0.97f
    const val lyricCascadeChaseSpeedGradient: Float = 0.82f
    const val lyricCascadeDelayIncreaseMs: Float = 2.5f
    const val lyricCascadeDelayMs: Float = 14f
    const val lyricCascadeDurationMs: Float = 560f
    const val lyricCascadeFollowingDelayMs: Float = 22f
    ...
    const val lyricFocusScale: Float = 1.02f
    ...
    const val lyricScaleBounce: Float = 0.16f
    const val lyricScaleBounceDurationMs: Int = 420
    const val lyricScaleBounceEnabled: Boolean = true
    const val lyricScrollHideThresholdDp: Float = 24f
    const val lyricSnapThresholdMs: Float = 180f
